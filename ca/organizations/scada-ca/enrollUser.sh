...
function enrollOrg1() {
  ...
  #@p "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp/cacerts/"* "${PWD}/organizations/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem"
...
function enrollOrderer() {
  ...
  # Registering orderer
  #set -x
  #fabric-ca-client register --caname ca-orderer --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles "${PWD}/organizations/scada-ca/ordererOrg/tls-cert.pem"
  #{ set +x; } 2>/dev/null
  ...
  #set -x
  #fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/scada.com/orderers/orderer.scada.com/msp" --csr.hosts orderer.scada.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem"
  #{ set +x; } 2>/dev/null
